// Seleccionar todos los elementos en la página HTML
// y asignarlos a una variable
...
// Crear el elemento de audio para el reproductor
let curr_track = document.createElement('audio');

// Definir los valores utilizados globalmente
let track_index = 0;
let isPlaying = false;
let updateTimer;

// Crear la lista de pistas que se deben reproducir
let track_list = [
  {
    name: "Night Owl",
    artist: "Broke For Free",
    image: "Img/Owl.jpeg",
    path: "audio/06_night_owl.mp3"
  },
  {
    name: "Enthusiast",
    artist: "Tours",
  ...
  },
  {
    ...
    artist: "Chad Crouch",
    image: "Image URL",
    path: "audio/Chad_Crouch-Shipping_Lanes.mp3",
  },
];
